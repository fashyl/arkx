...
usersRouter.post('/register', register, nodemailer) // Register a new user. Upon successful registration, an email confirmation is sent.
...
usersRouter.patch('/', checkAuthentication, updateUserProfile) // Update current user's profile.
